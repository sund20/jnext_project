...
const About = () => {
  ...
  <h1  className='text-end text-5xl font-Ovo text-primary pt-10 mb-1'>About Me</h1>
       ...
       <motion.div
        ...
        >
        <p>
I am a highly creative and versatile developer skilled in delivering both frontend and full-stack solutions. My core expertise lies in building responsive, accessible, and visually appealing web experiences using modern foundational tools like HTML5, CSS, and JavaScript, alongside styling libraries (Sass, Bootstrap, and Tailwind CSS). I am actively expanding my capabilities by learning advanced frameworks such as React and Next.js. I understand modern deployment practices, seamlessly shipping production applications through Vercel via automated GitHub workflows. Beyond general web development, I possess valuable experience with specialized enterprise and educational platforms. I am proficient in Learning Management Systems (LMS) such as Moodle and Blackboard, where I customize core platforms and themes for both educational and corporate training environments.  Furthermore, I am actively investing in advanced content delivery systems, having completed the Adobe Experience Manager (AEM) Foundations course and currently working toward AEM certifications.
</p>
